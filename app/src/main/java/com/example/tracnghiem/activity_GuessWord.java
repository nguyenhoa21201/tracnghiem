...
public class activity_GuessWord extends AppCompatActivity {
        ...
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    case CHECK_ANWSER:
                        if (checkAnwser()) {
                            Toast.makeText(activity_GuessWord.this, "Good Job !", Toast.LENGTH_SHORT).show();
                            point += 1;
                            ...
                            Toast.makeText(activity_GuessWord.this, "Wrong !", Toast.LENGTH_SHORT).show();
                        ...
                        break;
                    case GAME_OVER:
                        Toast.makeText(activity_GuessWord.this, "GAME OVER", Toast.LENGTH_SHORT).show();
                        finish();
                        break;
                    default:
                        break;
    ...
    private void initComponets() {
        ...
        listQuestions.add(new Question(R.drawable.car, "car"));
        listQuestions.add(new Question(R.drawable.cat, "cat"));
        listQuestions.add(new Question(R.drawable.dog, "dog"));
